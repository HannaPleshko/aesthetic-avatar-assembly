...
export const RecommendedProducts = () => {
  ...
  return (
    <section className="flex w-full flex-col items-stretch mt-[130px] max-md:max-w-full max-md:mt-10">
      <h2 className="text-[64px] font-bold text-center max-md:max-w-full max-md:text-[40px] text-[rgba(248,228,190,1)]">
        recommended
      </h2>
      <div className="flex w-full items-center gap-9 overflow-hidden text-base text-white font-normal text-center leading-[34px] justify-center flex-wrap mt-[57px] px-[123px] max-md:max-w-full max-md:mt-10 max-md:px-5">
